...
button_recg=uicontrol(h_f,'style','push','string','1.开始运行','position',[100 50 100 50],'callback','face');  
button_match=uicontrol(h_f,'style','push','string','3.人脸识别','position',[400 50 100 50],'callback','GUIrecg'); 